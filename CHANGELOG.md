...
All notable changes to this project are documented here. The project follows [Semantic Versioning](https://semver.org/spec/v2.0.0.html) and the structure of [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).
...
- Public evidence-first solo-business validation Skill.
- English and Chinese onboarding plus two fictional examples.
